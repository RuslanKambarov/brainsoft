<template>
    <div class="row device">
        ...
        <div class="col-1"><input class="form-control" type='text' v-model="device.abbreviation"></div>
        <div class="col-1"><input class="form-control" type='text' v-model="device.owen_id"></div>
